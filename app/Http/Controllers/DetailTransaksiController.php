...
class DetailTransaksiController extends Controller
{
  ...
  // Do something with the result
        return view("table_master.detail_transaksi.index", compact('detailTransaksi', 'transaksi', 'paket', 'member', 'voucher', 'users', 'outlet', 'transaksi_pertama'));
    ...
    public function store(Request $request){
        ...
        return redirect()->route("transaksi.index")->with("message", [
            "message" => "Berhasil membuat transaksi dan detail transaksi",
            "type" => "success"
        ]);
    }
