...
<div class="main-panel">
    <div class="content-wrapper">
        ...
        <h3 class="mb-4">Tambah Data Voucher</h3>
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <form action="{{route('paket.store')}}" class="forms-sample" method="POST">
                                @csrf
                                <div class="row pt-20">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-success">
                                            ...
                                            <input type="text" class="form-control form-control-danger @error('nama_paket') is-invalid @enderror" name="nama_paket" value="{{ old("nama_paket")}}" placeholder="Masukkan Nama Paket" autocomplete="off">
                                            @error('nama_paket')
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <div class="form-group has-success">
                                            ...
                                            <input type="number" class="form-control form-control-danger @error('harga') is-invalid @enderror" name="harga" placeholder="Masukkan Harga" value="{{ old("harga")}}" autocomplete="off">
                                            @error('harga')
                                              <span class="invalid-feedback text-danger" role="alert">
                                                  <strong>{{ $message }}</strong>
                                              </span>
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <div class="form-group has-success">
                                            ...
                                            <input type="datetime" class="form-control form-control-danger @error('estimasi_waktu') is-invalid @enderror" name="estimasi_waktu" placeholder="Masukkan Estimasi Waktu" value="{{ old("estimasi_waktu")}} " autocomplete="off">
