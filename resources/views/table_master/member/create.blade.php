...
<div class="main-panel">
    <div class="content-wrapper">
        <h3 class="mb-4">Tambah Data Member</h3>
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <form action="{{route('member.store')}}" class="forms-sample" method="POST">
                                @csrf
                                <div class="row pt-20">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="nama" value="{{old('nama')}}" placeholder="Masukkan Nama Member"
                                                autocomplete="off">
                                            @error('nama')
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number"
                                                ...
                                                name="tlp" value="{{old('tlp')}}" placeholder="Masukkan No Telepon"
                                                autocomplete="off">
                                            @error('tlp')
                                            <span class="invalid-feedback text-danger" role="alert">
                                                <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-check form-check-inline">
                                          ...
                                          value="L" autocomplete="off" {{ @old("jenis_kelamin" == "L" ? "checked" : "") }} />
                                        ...
                                        <div class="form-check form-check-inline">
                                          ...
                                          value="P" autocomplete="off" {{ @old("jenis_kelamin" == "P" ? "checked" : "") }} />
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <div class="form-group has-success">
                                            ...
                                            <textarea name="alamat" class="form-control @error('alamat') is-invalid @enderror" rows="3" placeholder="Masukkan Alamat"> </textarea>
                                            @error('alamat')
                                              <span class="invalid-feedback text-danger" role="alert">
                                                  <strong>{{ $message }}</strong>
                                              </span>
